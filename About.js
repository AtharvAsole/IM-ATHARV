...
<motion.div variants={fadeIn('left', 0.5)} initial='hidden' whileInView={'show'} viewport={{once: false, amount: 0.3}} className='flex-1'>
    ...
    <h3 className='h3 mb-4'>I'm a Full Stack Developer (MERN)  with over 2 years of experience.</h3>
    <p className='mb-6'>
    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ultrices in iaculis nunc sed. Justo donec enim diam vulputate.
    </p>
    {/* stats */}
    <div className='flex gap-x-6 lg:gap-x-10 mb-12'>
      ...
      <div>
        <div className='text-[40px] font-tertiary text-gradient mb-2'>
         {
          InView ? 
          <CountUp start={0} end={12} duration={12} /> : null
         } 
         +
        </div>
      ...
      <div>
        ...
        <div className='font-primary text-sm tracking-[2px]'>ML<br /> Projects</div>
      </div>
